...
# just of effects. adding a delay of 1 second before performing any action...
SLEEP_BETWEEN_ACTIONS = 1
MAX_VAL = 100
DICE_FACE = 6

# snake will take a player down from 'key' to 'value'
snakes = {
    8: 4,
    18: 1,
    26: 10,
...
# ladder will take a player up from 'key' to 'value'
ladders = {
    3: 20,
    6: 14,
    11: 28,
